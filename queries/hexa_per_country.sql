INSERT INTO agg_test.hexa_per_country (dt_day_utc,token, country, country_code, count_of_requests,sum_traffic_bytes,duration_avg_ms,duration_med_ms,q90_duration_ms,_calc_utc )
