INSERT INTO agg_test.fr_iplb_per_hostname (dt_day_utc,token,hostname, count_of_requests,sum_traffic_bytes,duration_avg_ms,duration_med_ms,q90_duration_ms,_calc_utc )
