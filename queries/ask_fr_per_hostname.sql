INSERT INTO agg_test.ask_fr_per_hostname (dt_day_utc,token, hostname,count_of_requests,duration_avg_ms,duration_med_ms,q90_duration_ms,_calc_utc )

SELECT  toDate(created_on) as dt_day_utc ,
        replace(token , '\0','') as token,
        _node_hostname AS hostname ,
