INSERT INTO agg_test.cdn_per_provider (dt_day_utc,token, _provider, count_of_requests,sum_traffic_bytes,ttfb_avg_ms,ttfb_med_ms,q90_ttfb_ms,ttlb_avg_ms,ttlb_med_ms,q90_ttlb_ms,_calc_utc )
...
GROUP BY dt_day_utc , token , _provider
