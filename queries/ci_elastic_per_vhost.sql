INSERT INTO agg_test.ci_elastic_per_vhost (dt_day_utc,token,vhost, count_of_requests,sum_traffic_bytes,duration_avg_ms,duration_med_ms,q90_duration_ms,_calc_utc )
