INSERT INTO agg_test.fr_elastic_per_uri (dt_day_utc,token,uri, count_of_requests,sum_traffic_bytes,duration_avg_ms,duration_med_ms,q90_duration_ms,_calc_utc )
