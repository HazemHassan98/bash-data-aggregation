INSERT INTO agg_test.cdn_per_httpcode (dt_day_utc,token, http_code, count_of_requests,sum_traffic_bytes,ttfb_avg_ms,ttfb_med_ms,q90_ttfb_ms,ttlb_avg_ms,ttlb_med_ms,q90_ttlb_ms,_calc_utc )

SELECT  toDate(dt_utc) as dt_day_utc ,
        replace(_cdn_token , '\0','')  as token,
        toFixedString(toString(u_status_code),3) as http_code,
